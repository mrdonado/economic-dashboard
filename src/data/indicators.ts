...
export const indicators: Indicator[] = [
  ...
  { id: 'dxy', name: 'US Dollar Index', symbol: 'DX-Y.NYB', value: '104.32', change: '+0.08%', trend: 'up', category: 'Macro', description: 'US dollar strength against majors' },
  ...
  { id: 'dax', name: 'DAX', symbol: '^GDAXI', value: '18,374.53', change: '+0.41%', trend: 'up', category: 'Stocks', description: 'German equities' },
  { id: 'ibex', name: 'IBEX 35', symbol: '^IBEX', value: '11,023.40', change: '-0.12%', trend: 'down', category: 'Stocks', description: 'Spanish equities' },
  { id: 'nasdaq100', name: 'Nasdaq 100', symbol: '^NDX', value: '19,700.43', change: '+0.22%', trend: 'up', category: 'Stocks', description: 'Growth and technology equities' },
  { id: 'nikkei', name: 'Nikkei 225', symbol: '^N225', value: '38,804.65', change: '-0.36%', trend: 'down', category: 'Stocks', description: 'Japanese equities' },
  { id: 'sp500', name: 'S&P 500', symbol: '^GSPC', value: '5,487.03', change: '+0.15%', trend: 'up', category: 'Stocks', description: 'US large-cap equities' },
  { id: 'fear-greed-stocks', name: 'Stock Fear & Greed', symbol: 'CNN F&G', value: '38/100', change: 'Fear', trend: 'down', category: 'Stocks', description: 'US equity market sentiment' },
  { id: 'vix', name: 'VIX', symbol: '^VIX', value: '13.20', change: '-0.41', trend: 'down', category: 'Stocks', description: 'US equity volatility gauge' },
  ...
  { id: 'bitcoin', name: 'Bitcoin', symbol: 'BTC-USD', value: '$66,235', change: '+1.87%', trend: 'up', category: 'Crypto', description: 'Bitcoin / US dollar' },
  { id: 'fear-greed-crypto', name: 'Crypto Fear & Greed', symbol: 'FNG', value: '29/100', change: 'Fear', trend: 'down', category: 'Crypto', description: 'Crypto market sentiment' },
]
